        ...
        public async Task<List<string>?> ReadGroupMessages()
        {
            ...
            for (int i = 0; i < pages; i++)
            {
                ...
                foreach (var msgBase in messages.Messages)
                {
                    ...
                    {
                        if (Configuration.IsFilterDateFilter && msg.date > Configuration.TO_DATE) break;
                        if (Configuration.IsFilterDateFilter && msg.date < Configuration.FROM_DATE) continue;
                        ...
                        if (result.Value.IndexOf(".") > 0)
                        {
                            ...
                            if (Configuration.IsUsingBlacklist)
                            {
                            ...
                            {
                                if (!Configuration.PAIR_WHITELIST.Contains(pairsubstring))
                                continue;
